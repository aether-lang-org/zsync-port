...
void* v = ({ const char* _ad_6 = (const char*)(rcksum_hkey(h)); void* _ad_r = map_get_raw(z->rsum_hash, aether_string_data(_ad_6)); aether_heap_str_free(_ad_6); _ad_r; });
if (v == NULL) {
        {
...
({ const char* _ad_7 = (const char*)(rcksum_hkey(h)); int _ad_r = map_put_raw(z->rsum_hash, aether_string_data(_ad_7), rcksum_box_int((id + 1))); aether_heap_str_free(_ad_7); _ad_r; });
}
